...
export default function Register() {
  ...
  const handleGoogleRegister = () => {
    setServerError('')
    if (!role) {
      setServerError('Please select a role before continuing with Google.')
      return
    }
    if ((role === 'doctor' || role === 'assistant') && !clinicId) {
      setServerError('Please select a clinic before continuing with Google.')
      return
    }
    window.location.href = getGoogleRedirectUrl(role, clinicId || null)
  }
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-100 px-4 py-10">
      <div className="w-full max-w-md">
        ...
        <div className="card">
          ...
          {/* Role + Clinic selectors appear first so Google button can use their values */}
          ...
          <button
            ...
            className="w-full mt-2 flex items-center justify-center gap-3 rounded-lg border border-gray-300 bg-white px-4 py-2.5 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2"
          >
