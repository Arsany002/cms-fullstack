...
- Name: auth/login.spec.js >> Login page >> doctor login redirects to doctor dashboard
- Location: tests/e2e/auth/login.spec.js:48:3
      ...
      - generic [ref=e11]:
        - generic [ref=e12]:
          ...
          - textbox "Email address" [ref=e14]:
            ...
            - text: e2e_doctor_1781564603839@example.com
        - generic [ref=e15]:
